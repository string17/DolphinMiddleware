...
namespace DolphinContext.Data.Models
{
	public partial class DolphinDb : Database
	{
		...
		[TableName("dbo.Dol_Incident_Part")]
		[PrimaryKey("Id")]
		[ExplicitColumns]
		public partial class DolIncidentPart : DolphinDb.Record<DolIncidentPart>  
		{
			...
			{ 
				get { return _Stockid; }
				set { _Stockid = value; Track("StockId"); }
			}
			int? _Stockid;
			...
			public static IEnumerable<DolIncidentPart> Query(Database db, string[] columns = null, int[] Id = null)
            {
                var sql = new Sql();
                ...
                sql.From("dbo.Dol_Incident_Part (NOLOCK)");

				if (Id != null)
					sql.Where("Id IN (@0)", Id);

                return db.Query<DolIncidentPart>(sql);
            }
		}
		
		[TableName("dbo.Dol_Stocked_Part")]
		[PrimaryKey("StockId")]
		[ExplicitColumns]
		public partial class DolStockedPart : DolphinDb.Record<DolStockedPart>  
		{
			[Column("StockId")] public int Stockid 
			{ 
				get { return _Stockid; }
			...
			string _Itemname;
			[Column("StockDesc")] public string Stockdesc 
			{ 
				get { return _Stockdesc; }
				set { _Stockdesc = value; Track("StockDesc"); }
			}
			string _Stockdesc;
			...
			string _Serialno;
			[Column("ValueRate")] public decimal? Valuerate 
			{ 
				get { return _Valuerate; }
				set { _Valuerate = value; Track("ValueRate"); }
			}
			decimal? _Valuerate;
			[Column("StockQty")] public int? Stockqty 
			{ 
				get { return _Stockqty; }
				set { _Stockqty = value; Track("StockQty"); }
			}
			int? _Stockqty;
			[Column("ItemStatus")] public string Itemstatus 
			{ 
				get { return _Itemstatus; }
				set { _Itemstatus = value; Track("ItemStatus"); }
			}
			string _Itemstatus;
			[Column("StockedBy")] public string Stockedby 
			{ 
				get { return _Stockedby; }
				set { _Stockedby = value; Track("StockedBy"); }
			}
			string _Stockedby;
			[Column("StockedOn")] public DateTime? Stockedon 
			{ 
				get { return _Stockedon; }
				set { _Stockedon = value; Track("StockedOn"); }
			}
			DateTime? _Stockedon;
		
			public static IEnumerable<DolStockedPart> Query(Database db, string[] columns = null, int[] Stockid = null)
            {
                var sql = new Sql();
                ...
                sql.From("dbo.Dol_Stocked_Part (NOLOCK)");

				if (Stockid != null)
					sql.Where("StockId IN (@0)", Stockid);

                return db.Query<DolStockedPart>(sql);
            }
		}
		...
		public partial class UserTracking : DolphinDb.Record<UserTracking>  
		{
			...
			string _Sessionid;
			[Column("IsUserLogOut")] public bool? Isuserlogout 
			{ 
				get { return _Isuserlogout; }
				set { _Isuserlogout = value; Track("IsUserLogOut"); }
			}
			bool? _Isuserlogout;
			[Column("IsUserLogOff")] public bool? Isuserlogoff 
			{ 
				get { return _Isuserlogoff; }
				set { _Isuserlogoff = value; Track("IsUserLogOff"); }
			}
			bool? _Isuserlogoff;
			[Column("SystemIp")] public string Systemip 
			{ 
		...
		[TableName("dbo.Dol_Incident")]
		[PrimaryKey("IncidentId")]
		[ExplicitColumns]
		public partial class DolIncident : DolphinDb.Record<DolIncident>  
		{
			[Column("IncidentId")] public long Incidentid 
			{ 
				get { return _Incidentid; }
				set { _Incidentid = value; Track("IncidentId"); }
			}
			long _Incidentid;
			[Column("IncidentTitle")] public string Incidenttitle 
			{ 
				get { return _Incidenttitle; }
				set { _Incidenttitle = value; Track("IncidentTitle"); }
			}
			...
			string _Terminalno;
			[Column("IncidentPriority")] public string Incidentpriority 
			{ 
				get { return _Incidentpriority; }
				set { _Incidentpriority = value; Track("IncidentPriority"); }
			}
			string _Incidentpriority;
			[Column("LoggedBy")] public string Loggedby 
			{ 
				get { return _Loggedby; }
				set { _Loggedby = value; Track("LoggedBy"); }
			}
			string _Loggedby;
			[Column("LoggedOn")] public DateTime? Loggedon 
			{ 
				get { return _Loggedon; }
				set { _Loggedon = value; Track("LoggedOn"); }
			}
			DateTime? _Loggedon;
			[Column("TreatedBy")] public string Treatedby 
			{ 
				get { return _Treatedby; }
				set { _Treatedby = value; Track("TreatedBy"); }
			}
			string _Treatedby;
			[Column("EngineerAssigned")] public string Engineerassigned 
			{ 
				get { return _Engineerassigned; }
				set { _Engineerassigned = value; Track("EngineerAssigned"); }
			}
			string _Engineerassigned;
			[Column("TestDiagnosed")] public string Testdiagnosed 
			{ 
				get { return _Testdiagnosed; }
				set { _Testdiagnosed = value; Track("TestDiagnosed"); }
			}
			string _Testdiagnosed;
			[Column("TreatedOn")] public DateTime? Treatedon 
			{ 
				get { return _Treatedon; }
				set { _Treatedon = value; Track("TreatedOn"); }
			}
			DateTime? _Treatedon;
			[Column("ResolvedOn")] public DateTime? Resolvedon 
			{ 
				get { return _Resolvedon; }
				set { _Resolvedon = value; Track("ResolvedOn"); }
			}
			DateTime? _Resolvedon;
			[Column("ResolvedBy")] public string Resolvedby 
			{ 
				get { return _Resolvedby; }
				set { _Resolvedby = value; Track("ResolvedBy"); }
			}
			string _Resolvedby;
			[Column("IsCallResolved")] public bool? Iscallresolved 
			{ 
				get { return _Iscallresolved; }
				set { _Iscallresolved = value; Track("IsCallResolved"); }
			}
			bool? _Iscallresolved;
			[Column("IsPartReplaced")] public bool? Ispartreplaced 
			{ 
				get { return _Ispartreplaced; }
				set { _Ispartreplaced = value; Track("IsPartReplaced"); }
			}
			bool? _Ispartreplaced;
			[Column("PEGrade")] public string Pegrade 
			{ 
				get { return _Pegrade; }
				set { _Pegrade = value; Track("PEGrade"); }
			}
			string _Pegrade;
			[Column("ClosedRemark")] public string Closedremark 
			{ 
				get { return _Closedremark; }
				set { _Closedremark = value; Track("ClosedRemark"); }
			}
			string _Closedremark;
		
			public static IEnumerable<DolIncident> Query(Database db, string[] columns = null, long[] Incidentid = null)
            {
                var sql = new Sql();
                ...
                sql.From("dbo.Dol_Incident (NOLOCK)");
